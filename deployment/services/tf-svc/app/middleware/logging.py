...
WHY STRUCTURED LOGS:
    ...
    "show me all 5xx on /translate slower than 500ms in the last hour"
...
WHY STRUCTLOG (vs raw stdlib `logging`):
    ...
    tensorflow) emit through the same JSON pipeline. Single output
    stream, consistent format.
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(
        ...
        # request - including from translation_loader and the router -
        # will automatically include {"request_id": "..."} in the JSON
        # output.
